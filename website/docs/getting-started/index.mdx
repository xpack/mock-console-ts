...
The xPack Mock Console is a npm package available as [@xpack/mock-console](https://www.npmjs.com/package/@xpack/mock-console)
...
- **Star** the project on [GitHub](https://github.com/xpack/mock-console-ts/): It helps others discover our work.
