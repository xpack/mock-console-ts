...
[![GitHub package.json version](https://img.shields.io/github/package-json/v/xpack/mock-console-ts?color=green)](https://github.com/xpack/mock-console-ts/blob/mater/package.json)
...
```sh
npm --prefix ~/Work/npm-modules/mock-console-ts.git/website run clean
npm --prefix ~/Work/npm-modules/mock-console-ts.git/website run start
```
...
```sh
npm --prefix ~/Work/npm-modules/mock-console-ts.git/website run generate-website-blog-post
```
...
```bash
rm -rf ~/tmp/mock-console-test && mkdir ~/tmp/mock-console-test
npm --prefix ~/tmp/mock-console-test init --yes
npm --prefix ~/tmp/mock-console-test install @xpack/mock-console@next
```
...
```sh
npm --prefix ~/Work/npm-modules/mock-console-ts.git/website run build
```
...
- <code>npm dist-tag add @xpack/mock-console@{customField('releaseVersion')} latest</code>
- `npm dist-tag ls @xpack/mock-console`
