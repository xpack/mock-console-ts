...
[![CI on Push](https://github.com/xpack/mock-console-ts/actions/workflows/test-ci.yml/badge)](https://github.com/xpack/mock-console-ts/actions/workflows/test-ci.yml)
...
- determine the next version (like <code>1.0.0</code>)
- update the version in the top `package.json` file
- use the new version, suffixed by `-pre`, like <code>1.0.0-pre</code>.
...
- https://github.com/xpack/mock-console-ts/pulls

and fix them; assign them to a milestone
(like <code>1.0.0</code>).
...
- add a new entry like _**\* v1.0.0 prepared**_
- commit with a message like _**prepare v1.0.0**_
...
- commit with _**website: blog post release 1.0.0 published**_
...
```bash
rm -rf ~/tmp/mock-console-test && mkdir ~/tmp/mock-console-test && cd ~/tmp/mock-console-test
npm init --yes
npm install @xpack/mock-console@next
```
...
[GitHub Pages](https://xpack.github.io/mock-console-ts/).
...
[GitHub Actions](https://github.com/xpack/mock-console-ts/actions/workflows/publish-github-pages.yml).
...
in https://xpack.github.io/mock-console-ts/blog/
...
Check the result at https://xpack.github.io/mock-console-ts/.
...
In https://github.com/xpack/mock-console-ts/milestones:
...
<CodeBlock language="sh"> {
`npm dist-tag add @xpack/mock-console@1.0.0 latest
npm dist-tag ls @xpack/mock-console
`} </CodeBlock>
...
- npmjs.com [`@xpack/mock-console`](https://www.npmjs.com/package/@xpack/mock-console/) package
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/@xpack/mock-console)](https://www.npmjs.com/package/@xpack/mock-console/)
[![npm](https://img.shields.io/npm/dm/@xpack/mock-console)](https://www.npmjs.com/package/@xpack/mock-console/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack/mock-console)](https://www.npmjs.com/package/@xpack/mock-console/)
