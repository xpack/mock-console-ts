...
<Prerequisites nodeMajorVersion="18"/>
...
```sh
npm --prefix ~/Work/npm-modules/mock-console-ts.git publish --tag next
```
...
npm --prefix ~/tmp/mock-console-test init
...
- <code>npm dist-tag add @xpack/mock-console@{customField('npmVersion')} latest</code>
- `npm dist-tag ls @xpack/mock-console`
