...
git clone https://github.com/xpack/mock-console-ts.git logger-ts.git
```
...
git clone \
  --branch development \
  https://github.com/xpack/mock-console-ts.git logger-ts.git
```

Or, if the repo was already cloned:

```sh
git -C ~/Work/npm-modules/mock-console-ts.git pull
```
