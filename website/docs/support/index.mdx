...
# How to get help for the xPack Mock Console

## Quick links

The quick answer is to use the
[GitHub Discussions](https://github.com/xpack/mock-console-ts/discussions)
pages.
...
- Check the [GitHub Discussions](https://github.com/xpack/mock-console-ts/discussions) for
similar topics
- Check the [GitHub Issues](https://github.com/xpack/mock-console-ts/issues)
tracker and the
[GitHub Pull Requests](https://github.com/xpack/mock-console-ts/pulls)
for similar problems.
...
others, please 
use the [GitHub Discussions](https://github.com/xpack/mock-console-ts/discussions)
pages.
...
[GitHub Issues](https://github.com/xpack/mock-console-ts/issues)
tracker.
...
[GitHub Discussions](https://github.com/xpack/mock-console-ts/discussions)** pages.
