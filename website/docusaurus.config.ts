...
const config: Config = {
  ...
  tagline: 'A Node.js CommonJS/ES6 module with a mock console',
  ...
  baseUrl: '/mock-console-ts/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'xpack', // Usually your GitHub org/user name.
  projectName: 'mock-console-ts', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/xpack/mock-console-ts/edit/master/website/',
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/mock-console-ts/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/mock-console-ts/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/mock-console-ts/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/mock-console-ts/favicons/site.webmanifest'
      }
    }
  ],
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack/mock-console-ts/discussions',
            },
            {
